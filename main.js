...
(function() {
  ...
  function renderLottie(data) {
    ...
    try {
      ...
      console.error('Error rendering Lottie animation:', err);
      previewDiv.innerHTML = '<div style="color:red;text-align:center;">Error loading animation</div>';
    }
    renderTextsOverview(lottieData);
  }
  ...
  if (downloadBtn) {
    downloadBtn.addEventListener('click', function() {
      ...
      // 导出为标准格式，确保兼容性
      const jsonString = JSON.stringify(lottieData, null, 0);
